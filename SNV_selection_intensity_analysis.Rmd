...
```{r selection intensity calculation}
...
selection.output <- selection.intensity.calculation.function(genes_for_analysis = c("KRAS"),
...
save(selection.output,file = "output_data/KRAS_mutation_output.RData")
